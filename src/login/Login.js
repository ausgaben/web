              ...
              <>
                {this.isLogin() && (
                  <button
                    ...
                    onClick={() =>
                      this.setState({ step: STEP_RECOVER_PASSWORD })
                    }
                  >
                    Lost password?
                  </button>
          ...
          >
            {this.props.recoverPasswordResult && (
              <div className="alert alert-success" role="alert">
                {this.props.recoverPasswordResult.DeliveryMedium ===
                  'EMAIL' && (
                  <span>
                    Check your email{' '}
                    <code>{this.props.recoverPasswordResult.Destination}</code>{' '}
            ...
            <Input
              ...
              helpText={
                this.isRecoverPassword() ? (
                  <span>
                    Enter your username or email address in order to recover
                    your password.
                  </span>
                ) : null
              }
