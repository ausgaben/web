...
const mapStateToProps = (
  {
    spending: { error, success, isSubmitting },
    spending: { byId },
    checkingAccounts: { byId: checkingAccountsById }
  },
  {
    match: {
      params: { spendingId, checkingAccountId }
    }
  }
) => {
...
const mapDispatchToProps = (
  ...
  onEdit: (spending, changes) => dispatch(edit(spending, changes))
});
